...
import LastCapturePokemons from './componant/LastCapturePokemons';
import RandomPokemon from './componant/RandomPokemon';
import FirePokemons from './componant/FirePokemons';
...
function App() {
  ...
  return (
    <div className="App">
      <Header />
      <LastCapturePokemons pokemons = {pokemons}/>
